        ...
        return new List<DOMAIN.FMECA>
            {
                ...
                new DOMAIN.FMECA() {
                                    ...
                                    IsCriticalRisk=false,
                                    FMECAType =FMECAType.System,
                                    FMECAStatus =FMECAStatus.IntialAssessmentComplete,
                                    TopLevelPartNumber="TopLevelPartNumber",
                                    TopLevelPartDescription="TopLevelPartDescription",
                                    ProcessName="ProcessName",
                                    Owner="Owner",
                ...
                new DOMAIN.FMECA() {
                                    ...
                                    IsCriticalRisk=false,
                                    FMECAType =FMECAType.System,
                                    FMECAStatus =FMECAStatus.CorrectiveActionAssigned,
                                    TopLevelPartNumber="TopLevelPartNumber",
                                    TopLevelPartDescription="TopLevelPartDescription",
                                    ProcessName="ProcessName",
                                    Owner="Owner",
                ...
                new DOMAIN.FMECA() {
                 ...
                 new DOMAIN.FMECA() {
                                    ...
                                    FMECAStatus =FMECAStatus.CorrectiveActionComplete,
                                    ProcessFMECAType=ProcessFMECAType.Electric,
                                    TopLevelPartNumber="TopLevelPartNumber",
                                    TopLevelPartDescription="TopLevelPartDescription",
                                    ProcessName="ProcessName",
                ...
                new DOMAIN.FMECA() {
                                    ...
                                    IsCriticalRisk=false,
                                    FMECAType =FMECAType.Design,
                                    FMECAStatus =FMECAStatus.PostActionScoringComplete,
                                    TopLevelPartNumber="TopLevelPartNumber",
                                    TopLevelPartDescription="TopLevelPartDescription",
                                    ProcessName="ProcessName",
                                    Owner="Owner",
